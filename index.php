...
<div class="head">
    <nav>
        ...
        <img src="assets/images/blue logo.png" class="im"/>
...
<br>
<div class="container">
    <form id="myform" action="pages/logincheck.php" method="POST">
        <div class="contents">
            <h1>Welcome to Shopify <br> Login</h1><br>
            <input type="text" class="name" name="username" placeholder="Enter your Name" required><p></p>
            <input type="password" class="number" placeholder="Password" name="password" required><p></p>
